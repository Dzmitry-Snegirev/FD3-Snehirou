...
class ProductLine extends React.Component {
	...
	render() {
		return (<tbody className={'items'}>
			<tr className={'info'} onClick={this.props.workMode !== "addproduct" ? this.selectLine : undefined} style={{ backgroundColor: (this.props.startCode === this.props.code) ? 'orange' : 'white' }} >
